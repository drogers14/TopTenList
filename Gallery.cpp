...
// puts a new emoticon w/ its description to the end of the gallery
void Gallery::add(string emoticon, string text){
  ...
  //Safe access to the gallery collection, which returns a blank emoticon
  //if the provided index is put of bounds
